...
//   checkslov();
// };
var selesai = document.getElementById("okButton-d");
function checkslov() {
  if (selesai) {
    kolombaru.style = "";
    otomatis();
...
const popupContainerJ = document.getElementById("popupContainer-j");
const popupContainerD = document.getElementById("popupContainer-d");
const closePopupJ = document.getElementById("closePopup-j");
var closePopupD = document.getElementById("closePopup-d");
const okButtonJ = document.getElementById("okButton-j");
const okButtonD = document.getElementById("okButton-d");

closePopupJ.addEventListener("click", () => {
  popupContainerJ.style.display = "none";
});

closePopupD.addEventListener("click", () => {
  popupContainerD.style.display = "none";
});

okButtonJ.addEventListener("click", () => {
  popupContainerJ.style.display = "none";
});

// jeroe
var tombol2 = document.getElementById("jerome-btn");
tombol2.addEventListener("click", () => {
  popupContainerJ.style.display = "flex";
});

//deo
var tombol1 = document.getElementById("deo-btn");
tombol1.addEventListener("click", () => {
  popupContainerD.style.display = "flex";
});
